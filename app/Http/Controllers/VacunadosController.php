...
class VacunadosController extends Controller
{
    ...
    public function ApiInformacionCompletaVacunadosMpps()
    {
        ...
        dosis3,lote3, fecha_dosis3,
        dosis4,fecha_dosis4,lote4,
   ...
   public function listadoVacunadosPorCentroSalud($centro_salud_id)
   {
     ...
     public function store(Request $request)
    {
        ...
        $vacunado->lote4 = $request->input('lote4');
        $vacunado->fecha_dosis4 = $request->input('fecha_dosis4');
        $vacunado->dosis4 = $request->input('dosis4');
...
{
    $inventarios = DB::select("SELECT tipo_identificacion ,cedula, nombres, apellidos,fecha_nacimiento, vacunados.email, lote3, fecha_dosis3, dosis3, lote4, fecha_dosis4, dosis4,
...
{
    $inventarios = DB::select("SELECT tipo_identificacion ,cedula, nombres, apellidos,fecha_nacimiento, vacunados.email,dosis1,lote1, fecha_dosis1, dosis2,lote2, fecha_dosis2,
    V1.nombre_vacuna,dosis3,fecha_dosis3,  lote3, dosis4,fecha_dosis4, lote4, V2.nombre_vacuna AS refuerzo,
